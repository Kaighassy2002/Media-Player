...
import {getAllVideoAPI, getSingleCategoryAPI, updateCategeoryAPI} from '../services/allAPI'
...
const handleCategoryVideo = async(e)=>{
  ...
  const result = await updateCategeoryAPI(categoryId,{id,categoryName,allVideos:updatedVideoList})
